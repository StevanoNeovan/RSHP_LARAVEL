    ...
    <table border="1" width="100%">
        <tr>
            <td width="20%" valign="top">
                <div>
                    <h2><i class="fas fa-user-md"></i> RSHP UNAIR</h2>
                    <p>Dokter Hewan</p>
                </div>
                <hr>
                <nav>
            ...
            <td width="80%" valign="top" style="padding: 20px;">
                ...
                <table width="100%">
                    <tr>
                        <td>
                            <h1><i class="fas fa-th-large"></i> Dashboard Dokter</h1>
                        </td>
                        <td align="right">
                ...
                <div style="background-color: #f0f0f0; padding: 20px; margin-top: 20px; margin-bottom: 20px;">
                    {{-- NAMA DOKTER SUDAH DISESUAIKAN --}}
                    <h2>Selamat Datang, {{ $dokter->nama }}! 👋</h2>
                    <p>Berikan pelayanan kesehatan terbaik untuk hewan dengan profesionalisme dan dedikasi tinggi.</p>
                </div>
                    ...
                    <tr>
                        <td width="50%" align="center" style="border: 1px solid #ccc; padding: 20px;">
                            ...
                            <a href ="{{ route('dokter.rekam-medis.index') }}">
                                ...
                                <h3>Lihat Rekam Medis</h3>
                                <p>Akses dan kelola rekam medis pasien hewan</p>
                            </a>
                        </td>
                        <td width="50%" align="center" style="border: 1px solid #ccc; padding: 20px;">
                            {{-- LINK SUDAH DIPERBAIKI --}}
                            <a href="{{ route('dokter.rekam-medis.index') }}">
                                <div><i class="fas fa-stethoscope" style="font-size: 35px;"></i></div>
                                <h3>Pemeriksaan</h3>
                                <p>Lakukan pemeriksaan dan diagnosis hewan</p>
                            </a>
                        </td>
                    </tr>
                </table>
