...
<div class="form-container">
    <div class="form-card">
        <div class="form-card-header">
            ...
            <p>Isi semua informasi pet dengan lengkap dan benar</p>
        </div>
        ...
        <form action="{{ route('admin.pet.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                @else
                    <div class="form-help">Pilih pemilik dari daftar yang tersedia</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-help">Pilih jenis hewan terlebih dahulu untuk memfilter ras</div>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="idras_hewan" id="rasHewanSelect" class="form-select @error('idras_hewan') error @enderror" required disabled>
                    <option value="">-- Pilih Jenis Hewan Terlebih Dahulu --</option>
                    @foreach($rasHewan as $ras)
                        <option value="{{ $ras->idras_hewan }}" data-jenis="{{ $ras->idjenis_hewan }}" {{ old('idras_hewan') == $ras->idras_hewan ? 'selected' : '' }}>
                            {{ $ras->nama_ras }}
                        </option>
                    @endforeach
                </select>
                ...
                @else
                    <div class="form-help">Ras akan muncul setelah memilih jenis hewan</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                @else
                    <div class="form-help">Masukkan tanggal lahir pet (estimasi jika tidak pasti)</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input 
                    ...
                    placeholder="Contoh: Putih bintik hitam, Abu-abu bergaris"
                    required
                >
                @error('warna_tanda')
                    <div class="form-error">
                ...
                @else
                    <div class="form-help">Deskripsikan warna dan ciri khas pet</div>
                @enderror
            </div>
...
<script>
    ...
    jenisSelect.addEventListener('change', function() {
        ...
        // Clear and disable if no jenis selected
        if (!selectedJenis) {
