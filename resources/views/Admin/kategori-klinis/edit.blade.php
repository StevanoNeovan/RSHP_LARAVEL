...
<div class="section-wrapper">
    ...
    <h3 style="margin:0;">Edit Kategori Klinis</h3>
    ...
    @method('PUT')
        ...
        <input type="hidden" name="idkategori_klinis" value="{{ $kategoriKlinis->idkategori_klinis }}">

        <div class="form-row">
            <div class="form-label">Nama Kategori Klinis</div>
